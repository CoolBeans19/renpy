...
init -1 python hide:
    ...
    style.button.activate_sound = "click1.wav"
    style.imagemap.activate_sound = "click1.wav"
    ...
    config.main_menu_music = "priceoffailure.ogg"
...
python early:
    config.save_directory = "Akira-1447437126"
